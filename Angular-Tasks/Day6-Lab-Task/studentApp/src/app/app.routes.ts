...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      // insert / edit course (same component, optional :id)
      { path: 'insertcourse', component: InsertCourseComponent, title: 'Add Course', canActivate: [authGuard] },
      { path: 'insertcourse/:id', component: InsertCourseComponent, title: 'Edit Course', canActivate: [authGuard] },
    ]
  },
